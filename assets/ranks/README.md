...
Le nom du fichier est **exactement l'id du rang**, en `.png` à fond
transparent. Il n'y a aucune liste à mettre à jour : les trois pages qui
l'affichent passent toutes par `rankMedalHTML()` (`js/main.js`), qui
construit le chemin à partir de l'id. Si le fichier manque, l'`<img>` se
retire d'elle-même et la mise en page redevient exactement celle d'avant.
